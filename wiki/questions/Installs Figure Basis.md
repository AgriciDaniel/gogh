---
type: "question"
title: "Installs Figure Basis"
status: "developing"
created: "2026-07-07"
updated: "2026-07-07"
tags: ["gogh/stack", "note/question"]
domain: "stack"
...
source_urls: ["https://www.skills.sh (retrieved 2026-07-07)", "https://github.com/nextlevelbuilder/ui-ux-pro-max-skill (retrieved 2026-07-07)", "https://www.tasteskill.dev/guide?view=full (retrieved 2026-07-07)", "https://snyk.io/articles/top-claude-skills-ui-ux-engineers/ (retrieved 2026-07-07)", "https://github.com/wilwaldon/Claude-Code-Frontend-Design-Toolkit (retrieved 2026-07-07)"]
sources: ["[[Reception Sources]]"]
---
Installs Figure Basis tracks why six-skill install comparisons are incomplete and should not be treated as apples-to-apples adoption rankings.

## What it is
- skills.sh captured install counts for frontend-design, web-design-guidelines, Impeccable, and MIFB on 2026-07-07
- skills.sh did not provide a captured ui-ux-pro-max count because that skill uses uipro CLI
- Taste Skill registry count was not captured in the same comparison
- Older install figures appear in directories with different bases
- Install comparisons are incomplete by construction
- Safe practice is to date and source every install number.
...
- Keep the resolution path explicit.
- Update dependent notes only after new evidence is captured.
...
## Next actions
- Keep the current answer and resolution path visible.
- Close only with dated source evidence.
