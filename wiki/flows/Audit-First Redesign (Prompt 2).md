...
created: "2026-07-07"
updated: "2026-07-07"
tags: ["gogh/taste-skill", "note/flow"]
domain: "taste-skill"
...
source_urls: ["https://www.tasteskill.dev/guide?view=full (retrieved 2026-07-07)", "https://raw.githubusercontent.com/Leonxlnx/taste-skill/main/skills/taste-skill/SKILL.md (retrieved 2026-07-07)", "https://www.tasteskill.dev/changelog (retrieved 2026-07-07)"]
sources: ["[[Taste Skill Official Site]]", "[[Canonical Skill File]]"]
---
Audit-First Redesign is the official Taste Skill flow for changing an existing site only after preservation and SEO constraints are explicit.

## What it is
- Official site publishes Prompt 2 for redesigning an existing website
- Brief fields include site, mode, audience, what works, what is broken, and SEO constraint
- Step 1 runs Section 11 audit before implementation
- Audit records brand tokens, information architecture, patterns, dial reading, and SEO baseline
- Step 2 declares mode and modernization levers
- Step 3 implements after approval
- Step 4 runs em-dash, pre-flight, preservation, and brand fidelity audits.
...
- [[Modernization Modes]] - defines preserve, overhaul, and greenfield-with-content-preserved modes.

## Next actions
- Preserve official stop points and approval gates.
- Use this flow only when the scope matches.
