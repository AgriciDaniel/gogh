...
---
Modernization Modes define whether Taste Skill should preserve, overhaul, or treat a redesign as greenfield-with-content-preserved.

## What it is
- Raw SKILL.md defines Greenfield, Redesign Preserve, and Redesign Overhaul modes
- Preserve mode modernizes without breaking brand
- Overhaul mode changes visual language while preserving content and information architecture
- Greenfield applies when no existing site or full overhaul is approved
- Modernization levers run from typography refresh to full block replacement
- Full block replacement is highest risk.
