...
---
Image-First Reference Pipeline is the Taste Skill workflow for resolving visual direction in images before implementation.

## What it is
- Theory extract describes reference frames, analysis, and implementation
- Taste Skill prioritizes image-generation tools when available
- Official greenfield prompt requires real images
- The pipeline narrows open-ended generation into a concrete visual target
- image-to-code belongs to the 13-skill suite
- The workflow does not replace brand approval or accessibility testing.
