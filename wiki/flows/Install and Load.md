...
source_urls: ["https://www.tasteskill.dev/guide?view=full (retrieved 2026-07-07)", "https://raw.githubusercontent.com/Leonxlnx/taste-skill/main/skills/taste-skill/SKILL.md (retrieved 2026-07-07)", "https://api.github.com/repos/Leonxlnx/taste-skill (retrieved 2026-07-07)", "https://www.anthropic.com/engineering/equipping-agents-for-the-real-world-with-agent-skills (retrieved 2026-07-06)"]
sources: ["[[Taste Skill Official Site]]", "[[Canonical Skill File]]"]
---
Install and Load is the Taste Skill flow for adding design-taste-frontend and loading it once at the top of an agent session.

## What it is
- Official guide says to load the skill once at the top of the session
- Default install command uses npx skills add against the Leonxlnx repository and skill name design-taste-frontend
- Official site also documents full bundle and Codex-specific install
- Active default is v2 experimental as of 2026-07-07
- v1 is preserved as design-taste-frontend-v1
- The flow depends on the SKILL.md Agent Skills format.
