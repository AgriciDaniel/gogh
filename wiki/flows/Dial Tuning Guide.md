...
---
Dial Tuning Guide turns brief signals into DESIGN_VARIANCE, MOTION_INTENSITY, and VISUAL_DENSITY values.

## What it is
- Raw SKILL.md provides dial inference table and use-case presets
- Baseline is 8, 6, 4 when the design read does not override it
- Minimalist signals lower all three dials
- Premium consumer keeps higher variance and middle motion
- Playful and agency signals push variance and motion high
- Trust-first and regulated signals lower variance and motion
- Redesign preserve matches existing and adds one to motion
- Redesign overhaul adds two to variance and motion while matching density.
