...
---
Greenfield Build is the official Taste Skill prompt flow for creating a new landing, portfolio, or marketing page from a brief.

## What it is
- Official site publishes Prompt 1 for a new website
- Brief fields include page kind, product, audience, vibe words, references, and avoid patterns
- Step 1 requires design read and dials before implementation
- Step 2 asks for a single Next.js page with at least eight sections after approval
- Prompt requires at least four layout families
- Prompt requires real images
- Step 3 requires written audits and any Fail blocks completion.
