...
source_urls: ["https://www.tasteskill.dev/guide?view=full (retrieved 2026-07-07)", "https://api.github.com/repos/Leonxlnx/taste-skill (retrieved 2026-07-07)", "https://www.tasteskill.dev/changelog (retrieved 2026-07-07)"]
sources: ["[[Canonical Skill File]]", "[[Taste Skill Official Site]]"]
---
The 13 Skills is the Taste Skill repository suite around design-taste-frontend, including image, redesign, output, style, and brandkit variants.

## What it is
- Claim pack records that the repository ships 13 skills
- Official-site extract lists taste-skill v2, taste-skill-v1, gpt-tasteskill, image-to-code-skill, redesign-skill, soft-skill, output-skill, minimalist-skill, brutalist-skill, stitch-skill, imagegen-frontend-web, imagegen-frontend-mobile, and brandkit
- Primary install name for v2 anchor is design-taste-frontend
- v1 is preserved as design-taste-frontend-v1
- Counts and names are current as of 2026-07-07.
...
- [[Anti-Laziness Research]] - backs the output-skill completion discipline.
