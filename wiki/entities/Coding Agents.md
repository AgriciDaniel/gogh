...
source_urls: ["https://www.tasteskill.dev/guide?view=full (retrieved 2026-07-07)", "https://www.anthropic.com/engineering/equipping-agents-for-the-real-world-with-agent-skills (retrieved 2026-07-06)", "https://raw.githubusercontent.com/Leonxlnx/taste-skill/main/skills/taste-skill/SKILL.md (retrieved 2026-07-07)", "https://api.github.com/repos/Leonxlnx/taste-skill (retrieved 2026-07-07)"]
sources: ["[[Canonical Skill File]]", "[[Source Manifest Guide]]"]
---
Coding Agents are the target runtime category for Taste Skill and the broader Gogh stack, including tools that read SKILL.md-style skills.

## What it is
- Official Taste Skill site lists Claude Code, Cursor, Codex, Gemini CLI, v0, Lovable, OpenCode, and more
- Official site says Taste Skill plugs into tools that support SKILL.md files
- Agent Skills source explains dynamic discovery and loading
- Ecosystem pack treats distribution as plural across skills, plugins, CLIs, hooks, and registries
- Compatibility claims remain dated because agent harnesses change.
