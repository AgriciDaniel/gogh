---
type: "rule"
title: "Taste Skill Dark Mode Protocol"
status: "developing"
created: "2026-07-07"
updated: "2026-07-07"
...
---
Taste Skill Dark Mode Protocol requires a page-level theme strategy, contrast parity, hierarchy parity, and no mid-page light-dark flipping by default.

## What it is
- Section 8 adds dual-mode dark mode protocol
- Token strategy can use Tailwind dark variants or CSS variables, but one strategy should be picked
- Brief and brand decide colors
- Body text should meet WCAG AA and hero copy targets AAA
- Hierarchy parity means CTA prominence survives both modes
- Pure black and pure white are discouraged
- Page Theme Lock blocks random section inversions.
