---
type: "rule"
title: "Taste Skill Typography Rules"
status: "developing"
created: "2026-07-07"
updated: "2026-07-07"
...
---
Taste Skill Typography Rules define the captured v2 defaults and bans for display scale, body measure, font choice, serif use, and italic descender clearance.

## What it is
- Display default is text-4xl md:text-6xl tracking-tighter leading-none
- Body default is text-base, relaxed line height, and max-w 65ch
- Inter is discouraged as default with contextual override paths
- Fraunces and Instrument Serif are banned as defaults
- Serif defaults are discouraged unless brand or aesthetic justifies them
- Emphasis inside a headline should use italic or bold of the same family
- Italic display words with descenders need leading 1.1 minimum and reserve spacing.
