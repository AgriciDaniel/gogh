...
---
Taste Skill Color Rules enforce one accent, restrained saturation, brand-aware purple overrides, and a banned premium-consumer beige-and-brass default.

## What it is
- Raw rule limits a page to one accent color
- Default accent saturation is below 80 percent
- Lila rule discourages automatic purple or blue glows while allowing brand purple
- Color Consistency Lock requires the accent across the whole page
- Premium-consumer briefs have banned beige, brass, oxblood, ochre, and espresso defaults
- Brand fidelity can override default bans when the brand already owns the color.
