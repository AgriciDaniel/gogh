...
---
The Three Locks are Taste Skill v2's page-level consistency checks for accent color, radius system, and theme.

## What it is
- Color Consistency Lock requires one accent color across the page
- Shape Consistency Lock requires one corner-radius system or a documented mixed rule
- Page Theme Lock requires one page-level light, dark, or auto strategy
- Locks make consistency checkable
- Brand fidelity can override a default color ban
- Theme lock prevents random section inversions.
