---
type: "rule"
title: "Taste Skill Motion Rules"
status: "developing"
created: "2026-07-07"
updated: "2026-07-07"
...
---
Taste Skill Motion Rules bind MOTION_INTENSITY to motivated motion, reduced-motion handling, transform-only animation, and canonical scroll patterns.

## What it is
- Motion is standardized on motion/react in new code
- framer-motion remains a legacy alias
- Motion above intensity 3 must honor reduced motion
- Motion above intensity 4 must be visible or the dial should drop to 3
- The skill bans window scroll listeners, window.scrollY in React state, and requestAnimationFrame loops touching React state
- GSAP sticky-stack and horizontal-pan patterns require start top top and pin true.
