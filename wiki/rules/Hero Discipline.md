...
---
Hero Discipline is Taste Skill v2's hard rule set for keeping the first viewport coherent, concise, and complete.

## What it is
- Hero headline max is two desktop lines
- Subtext max is 20 words and three to four lines
- CTA must be visible without scroll
- Desktop hero top padding cap is pt-24
- Hero text stack has at most four elements
- Trust logo walls belong below the hero
- Hero font scale should be planned with image size
- Four-line hero headlines are treated as font-size errors.
