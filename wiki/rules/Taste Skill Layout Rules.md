---
type: "rule"
title: "Taste Skill Layout Rules"
status: "developing"
created: "2026-07-07"
updated: "2026-07-07"
...
---
Taste Skill Layout Rules keep pages from repeating centered heroes, equal card grids, zigzags, empty bento cells, and unplanned mobile collapse.

## What it is
- Centered heroes are avoided when DESIGN_VARIANCE is above 4 unless justified
- Eight-section pages need at least four layout families
- Each section layout family appears at most once
- Bento grids have exactly as many cells as content items
- Three or more consecutive image-and-text zigzags fail
- Eyebrows are limited to one per three sections
- Mobile collapse must be explicit below 768px.
