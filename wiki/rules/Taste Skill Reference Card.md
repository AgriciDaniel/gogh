---
type: "rule"
title: "Taste Skill Reference Card"
status: "developing"
created: "2026-07-07"
updated: "2026-07-07"
...
---
Taste Skill Reference Card is the compact operating map for Taste Skill v2 dials, rules, workflows, audits, and open questions.

## What it is
- It summarizes the v2 experimental capture rather than adding new rules
- It points to the 8, 6, 4 dial baseline
- It links typography, color, motion, layout, dark mode, hero, navigation, locks, and AI tells
- It links install, greenfield, redesign, modernization, image-first, and dial flows
- It links Required Audits and Section 14 as enforcement
- It keeps v2 stable status dated because no stable release existed as of 2026-07-07.
...
- [[Taste Skill Color Rules]] - expands the color lock and palette bans.
- [[Taste Skill Layout Rules]] - expands layout-family and bento rules.
- [[Taste Skill Dark Mode Protocol]] - expands page-level theme rules.
- [[Taste Skill Typography Rules]] - expands type defaults and font bans.
- [[Taste Skill Motion Rules]] - expands motion and performance rules.
