...
---
Em-Dash Ban is Taste Skill v2's zero-tolerance visible-text rule for U+2014 and U+2013, with ASCII hyphen used for ranges and separators.

## What it is
- Raw v2 skill bans U+2014 anywhere visible on the page
- Same rule bans U+2013 when used as a separator
- Official guide quick reminders say zero em-dashes and hyphen only
- Ban applies to headlines, labels, pills, buttons, captions, nav, body, quotes, attribution, and alt text
- This wiki note names codepoints without printing the glyphs.
