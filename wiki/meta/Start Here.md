...
---
Start Here orients a Gogh reader through hot, index, hubs, and atomic notes while keeping Taste Skill inside the six-skill stack.

## What it is
- Gogh is a six-skill frontend design stack brain, not a single-skill Taste Skill vault
- Read path starts with Hot, then Index, then relevant hub, then atomic note
- Covered skills are Taste Skill, MIFB, Impeccable, Anthropic frontend-design, UI UX Pro Max, and Vercel web-design-guidelines
- Stack layers include taste prompting, micro-interaction execution, toolchain enforcement, retrieval database, and runtime audit
- V1 is advisory and read-only
- Repo should not be called market-ready unless required audit passes.
