---
type: "gap"
title: "Local Collection Unindexed"
status: "developing"
created: "2026-07-07"
updated: "2026-07-07"
...
source_urls: ["https://github.com/wilwaldon/Claude-Code-Frontend-Design-Toolkit (retrieved 2026-07-07)", "https://snyk.io/articles/top-claude-skills-ui-ux-engineers/ (retrieved 2026-07-07)", "https://www.skills.sh (retrieved 2026-07-07)"]
sources: ["[[Reception Sources]]", "[[Source Manifest Guide]]"]
---
Local Collection Unindexed records that local and curated design-skill collections exist, but Gogh has not indexed them into a source-cited local collection note set.

## What it is
- Ecosystem pack records curation layers such as wilwaldon and directories
- Link registry names Open Design Local Collection as an entity, but this S5h slice does not own that entity note
- Raw evidence warns directory descriptions are often derived from repositories
- Gap is about local indexing, not absence of public lists
- Safe path is to record sources before local collection summaries.
