...
---
No Cross-Skill Benchmark Data records that Gogh has mechanism and reception evidence for the six skills but no shared benchmark comparing their rendered output.

## What it is
- Ecosystem pack compares mechanisms, star counts, install channels, and reception
- Anthropic launch post uses qualitative examples but no formal eval methodology
- Taste Skill reception includes praise and criticism but not a controlled benchmark
- Impeccable has detector counts and anecdotes but not a shared benchmark against Taste Skill or MIFB
- The gap matters because stack order remains advisory.
