...
source_urls: ["https://www.anthropic.com/engineering/equipping-agents-for-the-real-world-with-agent-skills (retrieved 2026-07-06)", "https://github.com/Leonxlnx/taste-skill (retrieved 2026-07-07)", "https://www.tasteskill.dev/guide?view=full (retrieved 2026-07-07)"]
sources: ["[[Source Manifest Guide]]", "[[Canonical Skill File]]"]
---
Source Manifest Guide records how Gogh keeps raw captures, source-ledger rows, and wiki source notes aligned.

## What it is
- references/source-ledger.json is the machine-readable evidence ledger
- Raw captures under .raw are immutable source material
- Domain-specific claims need dated trustworthy sources
- Source notes keep topic notes traceable
- Retrieved-date discipline matters for fast-moving skill ecosystems
- The guide does not replace the original external source.
