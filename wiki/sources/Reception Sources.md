---
type: "source"
title: "Reception Sources"
status: "developing"
created: "2026-07-07"
updated: "2026-07-07"
tags: ["gogh/taste-skill", "note/source"]
domain: "taste-skill"
...
source_urls: ["https://andrew.ooo/posts/taste-skill-anti-slop-ai-frontend-review/ (retrieved 2026-07-06)", "https://neodrop.ai/post/s3mGLbLqiNd (retrieved 2026-07-06)", "https://github.com/wilwaldon/Claude-Code-Frontend-Design-Toolkit (retrieved 2026-07-07)", "https://snyk.io/articles/top-claude-skills-ui-ux-engineers/ (retrieved 2026-07-07)", "https://www.skills.sh (retrieved 2026-07-07)", "https://computertech.co/impeccable-ai-review/ (retrieved 2026-07-07)"]
sources: ["[[Reception Sources]]", "[[Source Manifest Guide]]"]
---
Reception Sources is the evidence bundle for adoption, praise, criticism, directories, and six-skill ecosystem framing.

## What it is
- It includes independent Taste Skill reviews from andrew.ooo and neodrop.ai
- It includes ecosystem curation from wilwaldon
- It includes skills.sh install observations from 2026-07-07
- It includes Snyk and market-list context with cautions about stale snapshots
- It includes the you-cannot-install-taste criticism as reception
- It includes Impeccable token-cost reception with a March 2026 v1.x caveat.
...
## Next actions
- Keep URLs synchronized with source-ledger rows.
- Do not replace original URLs with wiki-only citations.
