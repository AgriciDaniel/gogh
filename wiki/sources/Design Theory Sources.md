...
source_urls: ["https://claude.com/blog/improving-frontend-design-through-skills (retrieved 2026-07-07)", "https://prg.sh/ramblings/Why-Your-AI-Keeps-Building-the-Same-Purple-Gradient-Website (retrieved 2026-07-06)", "https://www.w3.org/community/design-tokens/2025/10/28/design-tokens-specification-reaches-first-stable-version/ (retrieved 2026-07-06)", "https://www.refactoringui.com/ (retrieved 2026-07-07)", "https://practicaltypography.com/ (retrieved 2026-07-07)"]
sources: ["[[Design Theory Sources]]", "[[Source Manifest Guide]]"]
---
Design Theory Sources is the source bundle for distributional convergence, constraint, tokens, hierarchy, typography, motion, and review-as-infrastructure claims.

## What it is
- It includes Anthropic distributional-convergence framing
- It includes the prg.sh purple-gradient explanation
- It includes W3C design-token stability evidence from October 2025
- It includes Refactoring UI for hierarchy and whitespace
- It includes Practical Typography for line length
- It supports theory notes, not current repository metadata.
