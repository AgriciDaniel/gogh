---
type: "audit"
title: "Section-layout-repetition audit"
status: "developing"
created: "2026-07-07"
updated: "2026-07-07"
...
---
Section-layout-repetition audit is the Taste Skill greenfield check that each section layout family is listed and repetition is blocked.

## What it is
- Official greenfield prompt requires this audit
- Raw skill says each section layout family can appear at most once
- Eight-section landing page must use at least four different layout families
- Consecutive zigzag image-text sections are capped at two
- Bento grids require exact cell counts
- Audit lists every section layout family.
