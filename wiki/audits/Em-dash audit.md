...
---
Em-dash audit is the written Taste Skill check that visible output contains zero U+2014 or U+2013 glyphs.

## What it is
- Official guide requires an em-dash audit in greenfield and redesign flows
- Raw skill bans U+2014 and U+2013 anywhere visible
- Audit includes headlines, labels, pills, body, quotes, attribution, captions, buttons, nav, and alt text
- Audit is binary and count must be zero
- Official quick reminders say hyphen only
- This note avoids printing the banned glyphs.
