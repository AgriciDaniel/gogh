...
---
Preservation audit verifies that a Taste Skill redesign did not silently change URLs, navigation, forms, anchors, brand, or legal copy.

## What it is
- Official redesign prompt requires a preservation audit
- Prompt says to list every URL, nav label, form field, and anchor changed
- Expected list is empty unless user approved changes
- Raw skill says route slugs, primary nav labels, form field names and order, brand logo, and legal or consent copy never change silently.
...
- Recheck the dated source lines before expanding this note.
