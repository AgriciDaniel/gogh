...
---
Brand fidelity audit verifies that a Taste Skill redesign preserved the existing accent color, type stack, and logo treatment unless the user approved an overhaul.

## What it is
- Official redesign prompt requires brand fidelity audit
- Section 11 records current brand tokens before changes
- Brand tokens include primary and accent colors, type stack, logo treatment, and radii
- Raw skill says a purple brand stays purple under the Lila override
- Audit applies most directly in preserve mode.
