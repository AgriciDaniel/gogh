...
---
Hero discipline audit verifies that the hero fits the first viewport, has concise copy, and keeps the CTA visible.

## What it is
- Official greenfield prompt requires a hero discipline audit
- Raw skill caps headline line count at two
- Raw skill caps subtext at 20 words and three to four lines
- CTA must be visible without scroll
- Desktop top padding cap is pt-24
- Hero stack can contain at most four text elements
- Audit reports headline lines, subtext words, and CTA visibility.
