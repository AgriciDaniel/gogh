---
type: "skill"
title: "Taste Skill (Project)"
status: "developing"
created: "2026-07-07"
updated: "2026-07-07"
tags: ["gogh/taste-skill", "note/skill"]
domain: "taste-skill"
...
source_urls: ["https://raw.githubusercontent.com/Leonxlnx/taste-skill/main/skills/taste-skill/SKILL.md (retrieved 2026-07-07)", "https://www.tasteskill.dev/guide?view=full (retrieved 2026-07-07)", "https://www.tasteskill.dev/changelog (retrieved 2026-07-07)", "https://api.github.com/repos/Leonxlnx/taste-skill (retrieved 2026-07-07)", "https://api.github.com/repos/Leonxlnx/taste-skill/releases (retrieved 2026-07-07)", "https://andrew.ooo/posts/taste-skill-anti-slop-ai-frontend-review/ (retrieved 2026-07-06)"]
sources: ["[[Canonical Skill File]]", "[[Taste Skill Official Site]]", "[[Reception Sources]]"]
---
Taste Skill is the Gogh stack anchor for macro frontend taste prompting: use it for landing pages, portfolios, and redesigns that need brief-first direction.

## What it is
- Mechanism category: taste prompting with dials, hard bans, and blocking pre-flight
- Author: Leon Lin, GitHub Leonxlnx
- License: MIT for Taste Skill itself
- Install command: `npx skills add https://github.com/Leonxlnx/taste-skill --skill "design-taste-frontend"`
- Repository recorded 59,770 stars as of 2026-07-07
- Last push was 2026-07-04 in the 2026-07-07 verification
- Active default is v2 experimental, not v2.0.0 stable as of 2026-07-07
- Releases API returned an empty array on 2026-07-07
- Newest official changelog entry remained May 2026 v2 experimental
- Baseline dials are DESIGN_VARIANCE 8, MOTION_INTENSITY 6, VISUAL_DENSITY 4
- Scope is landing pages, portfolios, and redesigns, not dashboards, data tables, or multi-step product UI
- Reach for it first for macro taste, then stack MIFB, Impeccable, retrieval, or audit layers as needed.
...
## Next actions
- Keep this anchor first in Taste Skill stack advice.
- Recheck releases before changing stable status.
