...
---
DESIGN_VARIANCE is the Taste Skill dial that controls how far a layout moves from predictable symmetry toward asymmetric composition.

## What it is
- Captured baseline sets DESIGN_VARIANCE to 8
- Scale runs from 1 perfect symmetry to 10 artsy chaos
- Levels 1 to 3 favor predictable symmetrical grids
- Levels 4 to 7 introduce offset layouts and varied ratios
- Levels 8 to 10 allow masonry, fractional grids, and large empty zones
- High-variance layouts require strict mobile collapse below 768px.
