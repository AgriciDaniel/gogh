...
source_urls: ["https://api.github.com/repos/Leonxlnx/taste-skill (retrieved 2026-07-07)", "https://github.com/Leonxlnx/taste-skill (retrieved 2026-07-07)", "https://raw.githubusercontent.com/Leonxlnx/taste-skill/main/skills/taste-skill/SKILL.md (retrieved 2026-07-07)", "https://www.tasteskill.dev/guide?view=full (retrieved 2026-07-07)"]
sources: ["[[Canonical Skill File]]", "[[Taste Skill Official Site]]"]
---
Anti-Laziness Research is the Taste Skill repository evidence folder behind output-skill completion discipline, not direct proof of visual taste quality.

## What it is
- GitHub capture records a research/laziness folder in the Taste Skill repository
- The folder supports output-skill, part of the 13-skill suite
- The raw extract summarizes studies about output length, task completion, prompt framing, and truncation behavior
- output-skill bans placeholder comments and half-finished output
- The evidence supports completion discipline, not frontend visual quality by itself.
