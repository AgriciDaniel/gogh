...
---
The Three Dials are Taste Skill v2 scalar controls for layout variance, motion intensity, and visual density, with a baseline of 8, 6, and 4 as of 2026-07-07.

## What it is
- Raw SKILL.md defines DESIGN_VARIANCE, MOTION_INTENSITY, and VISUAL_DENSITY on 1 to 10 scales
- Baseline is 8, 6, and 4
- Overrides happen conversationally rather than by editing the file
- The design read comes before dial setting
- Minimal, premium, playful, public-sector, preserve, and overhaul signals map to different values
- The dials steer later layout, motion, and density decisions.
