...
---
MOTION_INTENSITY is the Taste Skill dial that decides whether a page stays static, uses fluid transitions, or carries advanced choreography.

## What it is
- Captured baseline sets MOTION_INTENSITY to 6
- Scale runs from 1 static to 10 cinematic physics
- Levels 1 to 3 use hover and active states only
- Levels 4 to 7 use fluid CSS and reveal cascades
- Levels 8 to 10 use advanced scroll-triggered work when justified
- Reduced motion is mandatory above 3
- Motion above 4 must actually be visible or the dial should drop.
