...
source_urls: ["https://raw.githubusercontent.com/Leonxlnx/taste-skill/main/skills/taste-skill/SKILL.md (retrieved 2026-07-07)", "https://github.com/pbakaus/impeccable (retrieved 2026-07-07)", "https://impeccable.style/ (retrieved 2026-07-07)", "https://computertech.co/impeccable-ai-review/ (retrieved 2026-07-07)"]
sources: ["[[Reception Sources]]", "[[Canonical Skill File]]", "[[Impeccable Repo and Site]]"]
---
Stack Order Probe is a small experiment design for testing whether Taste Skill before or after Impeccable init changes frontend output quality and audit results.

## What it is
- Current evidence supports mechanisms but not stack-order benchmarks
- Taste Skill provides macro design read, dials, and pre-flight
- Impeccable init writes PRODUCT.md and DESIGN.md and supports detector enforcement
- Experiment compares Taste Skill before Impeccable init versus Impeccable init before Taste Skill
- Same brief, model, repo state, and time budget should be used
- Outputs should be judged by Section 14, Impeccable detect, screenshots, and a human rubric.
...
## Next actions
- Keep the protocol repeatable and read-only.
- Record raw observations before conclusions.
